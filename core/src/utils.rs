...
#[inline]
pub fn calc_crc(tstamp: u32, txn_id: u32, key_sz: u32, val_sz: u32, k: &[u8], v: &[u8]) -> u32 {
...
pub fn to_db_entry(
    ...
    // is_deleted + crc + tstamp + ksz + vsz + txn_id
...
#[inline]
pub fn to_hint_entry(tstamp: u32, txn_id: u32, k: &[u8], v: &[u8], val_pos: u64) -> Vec<u8> {
    // tstamp + txn_id + ksz + vsz + val_pos + key
